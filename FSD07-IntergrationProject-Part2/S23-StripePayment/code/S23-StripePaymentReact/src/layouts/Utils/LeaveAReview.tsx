...
export const LeaveAReview: React.FC<{ submitReview: any }> = (props) => {
  ...
  // After user rating the book,show description input form, otherwise there's no description input form
  const [displayInput, setDisplayInput] = useState(false);
  const [reviewDescription, setReviewDescription] = useState("");

  // Function to handle user clicking on star ratings.
  // It updates the star input value and displays the description input form.
  ...
  return (
    <div className="dropdown" style={{ cursor: "pointer" }}>
      {/* Dropdown toggle for leave a review */}
      <h5
      ...
      >
        {/* Dropdown items for different star ratings */}
        <li>
      ...
      {/* Display star rating component based on user selection */}
      <StarsReview rating={starInput} size={32} />
      {/* Display the description input form if user has selected a star rating */}
      {displayInput && (
